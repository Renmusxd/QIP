...
from qip.ext.kronprod import measure_probabilities, measure
...
print(measure_probabilities(numpy.array([0], dtype=numpy.int32), q1.n + q2.n + q3.n, o))


out = numpy.zeros(shape=(2**(q2.n + q3.n),), dtype=numpy.complex128)
print(measure(numpy.array([0], dtype=numpy.int32), q1.n + q2.n + q3.n, o, out, measured=0))